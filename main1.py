...
with col2:
    ...
    original_title = '<p style="font-family:Times New Roman;text-align: left; color:white; font-size: 22px;height:210px;">Medium Height and Incubation Time calculator for a given density and diameter to reach a desired deposition fraction of nano particle on the cell</p>'
    st.markdown(original_title, unsafe_allow_html=True)
